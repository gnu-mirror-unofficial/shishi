...
extern int _shisa_rmdir3 (const char *path1, const char *path2,
			  const char *path3);
extern int _shisa_rmdir4 (const char *path1, const char *path2,
			  const char *path3, const char *path4);
...
extern int _shisa_ls3 (const char *path1, const char *path2,
		       const char *path3,
		       char ***files, size_t *nfiles);
...
extern int _shisa_rm4 (const char *path1, const char *path2,
		       const char *path3, const char *path4);
