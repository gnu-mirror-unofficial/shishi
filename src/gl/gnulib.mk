...
# Reproduce by: gnulib-tool --import --dir=. --lib=libgnu --source-base=src/gl --m4-base=src/gl/m4 --doc-base=doc --aux-dir=build-aux --avoid=extensions --avoid=gettext --avoid=gettext-h --avoid=intprops --avoid=stdarg --avoid=string --makefile-name=gnulib.mk --libtool --macro-prefix=gl2 error locale version-etc
