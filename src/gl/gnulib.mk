...
# Reproduce by: gnulib-tool --import --dir=. --lib=libgnu --source-base=src/gl --m4-base=src/gl/m4 --doc-base=doc --aux-dir=build-aux --avoid=gettext --avoid=gettext-h --avoid=stdarg --makefile-name=gnulib.mk --libtool --macro-prefix=gl2 error version-etc
